					...
					<div class="btn-toolbar" style="margin: 0;">
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>						
								<li><a href="${createLink(uri: "/socialGroup/${action}Edit")}/${socialGroupBean?.socialGroup.id}"><i class="icon-edit"></i> <g:message code="default.button.edit.label" default="Edit"/></a></li>
								<!-- <li class="divider"></li> -->
								<li><a href="${createLink(uri: "/socialGroup/${action}Delete")}/${socialGroupBean?.socialGroup.id}"><i class="icon-trash"></i> <g:message code="default.button.delete.label" default="Delete"/></a></li>
							</ul>
						</div>
					</div>						
				</td>
